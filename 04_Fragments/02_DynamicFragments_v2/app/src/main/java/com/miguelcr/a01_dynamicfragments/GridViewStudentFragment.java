 ...
 */
public class GridViewStudentFragment extends Fragment {


    public GridViewStudentFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v =  inflater.inflate(R.layout.fragment_grid_view_student, container, false);

        GridView gridView = (GridView) v.findViewById(R.id.gridViewPortrait);
